public class HowAboutTrade : CutScenes
{
	...
	//	cutSceneNode = new();
	//	cutSceneNode.cutSceneCommand = ECommandType.ShowCharacterRightSide;
	...
	//	cutSceneNode = new();
	//	cutSceneNode.cutSceneCommand = ECommandType.ShowCharacterLeftSide;
	...
	//	cutSceneNode = new();
	//	cutSceneNode.cutSceneCommand = ECommandType.HighLightCharacterRightSide;
	//	cutSceneNodes.Add(cutSceneNode);
	...
	//	cutSceneNode = new();
	//	cutSceneNode.cutSceneCommand = ECommandType.ShowText;
	//	cutSceneNode.text = "오, 마법사님. 무슨 일이신가요?";
	//	cutSceneNode.name = "브로디";
	//	cutSceneNodes.Add(cutSceneNode);

	//	cutSceneNode = new();
	//	cutSceneNode.cutSceneCommand = ECommandType.HighLightCharacterLeftSide;
	//	cutSceneNodes.Add(cutSceneNode);
	...
	//	cutSceneNode = new();
	//	cutSceneNode.cutSceneCommand = ECommandType.HideText;
	//	cutSceneNodes.Add(cutSceneNode);
