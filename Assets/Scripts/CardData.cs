...
public class CardData : ICardEffect
{
	...
	public virtual IEnumerator NotifySummonEffectExecute(BattleManager bm, Servant servent) { yield break; }
	public virtual IEnumerator NotifyDeathEffectExecute(BattleManager bm, Servant servent) { yield break; }
}
public interface ICardEffect
{
	...
	IEnumerator NotifySummonEffectExecute(BattleManager bm, Servant servent);
	IEnumerator NotifyDeathEffectExecute(BattleManager bm, Servant servent);
}